...
3.1 Checking Model Behavior

Finding Equilibrium

```{r finding equilibrium, results in `final.model.output`}
...
Three parameter values I simulated this with were 0.01 (low), 0.1 (medium), 0.9 (high)

Chaning the transmission rate from host to tick, A
```{r changing A (host to tick)}
##########################
# A = 0.01
#########################
...
Changing gamma recovery rate for hosts (gamma)
```{r changing gamma}
##########################
# gamma = .01
#########################
...
Changing the rate of vertical transmission, v
```{r changing the rate of vertical transmssion, v}
##########################
# v = .01
#########################
...
Changing the birth rate, b
```{r changing birth rate, b}
##########################
# b = .01
#########################
...
Base parameters, same host densities
...
B.  burgdorferi
```{r B. burgdorferi host competency}
...
Comparing B. miyamotoi and B. burgdorferi with their unique host competencies
```{r}
#par(mfrow = c(1,1))
...
B. miyamotoi
```{r B. miyamotoi host-tick interactions}
#########################
# PERO : N = 26; A = .9; M = 10
#########################
  b = .1 # birth rate ticks
...
B. burgdorferi
``` {r B. burgdorferi host-tick interactions}
