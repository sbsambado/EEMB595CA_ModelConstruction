...
```
# this is a nonnegative matrix with elements that are greater than or equal to zero
# This makes it a irreducible matrix because the life cycle is strongly connected (i.e. there is a path in the graph from every node to every other node)
