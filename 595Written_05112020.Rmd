...
plot(results_equal[, 'time'], results_equal[,'I to I'], type = 'l', col = qiicol, 
     xlab = 'time', ylab = 'abundance', main = 'Transitions from Questing to Feeding, siga = alpha',
...
plot(results_HT[, 'time'], results_HT[,'I to I'], type = 'l', col = qiicol, 
     xlab = 'time', ylab = 'abundance', main = 'Transitions from Questing to Feeding, alpha >> sigma',
     ylim = c(0,100), lty = 1, lwd = 2)
...
plot(results_CF[, 'time'], results_CF[,'I to I'], type = 'l', col = qiicol, 
     xlab = 'time', ylab = 'abundance', main = 'Transitions from Questing to Feeding, sigma > alpha',
     ylim = c(0,100), lty = 1, lwd = 2)
...
plot(results_lower[, 'time'], results_lower[,'Xq'], type = 'l', col = 'red', 
     xlab = 'Time', ylab = 'Abundance',main = 'Tick population dynamics, temp. parameters decreased',
     ylim = c(0,100), lty = 1, lwd = 2)
