...
# all initial values = 1
  ...
  d = 0.01 # natural mortality ticks # OG .01 
  A_hat = 0.9 # transmission rate from ticks to hosts #OG .02
...
```{r nEED TO FIX analyze final.model.output R0, proportion}
##### Max number of ticks infected at one time? ####
## 198.9268
...
plot(x = tset, y = X.simu.bm.pero1, type = 'l', las = 1, lwd = 3,
     xlab = 'Time', ylab = 'Number of Infected Ticks',
     main = c('Number of Infected Ticks Produced by', paste('Differing Host Competencies (N = 50)')), cex.main = 1.2,
     col = 'maroon', lty = 1)
lines(x = tset, y = X.simu.bm.scoc1, lwd = 2, col = 'maroon')
lines(x = tset, y = X.simu.bm.nefu1, lwd = 1,col = 'maroon')
...
Question 3:
```{r Q3 host-tick interactions changing T0}
...
######### Plot change in v #################
plot(x = tset, y = Y.simu.bm.pero14, type = 'l', las = 1, lwd = 1, col = Ycol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Individuals',
     main = 'Incidence of Hosts and Ticks',
     ylim = c(0, 120), xlim = c(0, 60))
lines(x = tset, y = Y.simu.bm.pero15, col = Ycol, lwd = 2, lty = 1)
lines(x = tset, y = Y.simu.bm.pero16, col = Ycol, lwd = 3, lty = 1)
legend('topright', legend = c('Hosts (N = 50)','Ticks (N = 200)','A_hat = .001', 'A_hat = .1','A_hat = .9'),
        lty = 1, lwd = c(1,1,1,2,3), cex = 0.9, col = c(Hcol, Tcol, 'black','black','black'))
lines(x = tset, y = X.simu.bm.pero14, type = 'l', las = 1, lwd = 1, col = Xcol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Ticks',
     main = 'Incidence of Ticks (changing A_hat)',
     ylim = c(0, 120), xlim = c(0, 60))
lines(x = tset, y = X.simu.bm.pero15, col = Xcol, lwd = 2, lty = 1)
...
######### Plot change in A #################
plot(x = tset, y = Y.simu.bm.pero17, type = 'l', las = 1, lwd = 1, col = Ycol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Individuals',
     main = 'Incidence of Hosts and Ticks',
     ylim = c(0, 120), xlim = c(0, 60))
...
legend('topright', legend = c('Hosts (N = 50)','Ticks (N = 200)','A = .001', 'A = .1','A = .9'),
        lty = 1, lwd = c(1,1,1,2,3), cex = 0.9, col = c(Hcol, Tcol, 'black','black','black'))
lines(x = tset, y = X.simu.bm.pero17, type = 'l', las = 1, lwd = 1, col = Xcol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Ticks',
     main = 'Incidence of Ticks (changing A)',
     ylim = c(0, 120), xlim = c(0, 60))
lines(x = tset, y = X.simu.bm.pero18, col = Xcol, lwd = 2, lty = 1)
...
plot(x = tset, y = Y.simu.bm.pero20, type = 'l', las = 1, lwd = 1, col = Ycol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Individuals',
     main = 'Incidence of Hosts and Ticks',
     ylim = c(0, 120), xlim = c(0, 60))
...
legend('topright', legend = c('Hosts (N = 50)','Ticks (N = 200)','g = .001', 'g = .1','g = .9'),
        lty = 1, lwd = c(1,1,1,2,3), cex = 0.9, col = c(Hcol, Tcol, 'black','black','black'))
lines(x = tset, y = X.simu.bm.pero20, type = 'l', las = 1, lwd = 1, col = Xcol,lty = 2,
     xlab = 'Time', ylab = 'Number of Infected Ticks',
     main = 'Incidence of Ticks (changing A)',
     ylim = c(0, 120), xlim = c(0, 60))
lines(x = tset, y = X.simu.bm.pero21, col = Xcol, lwd = 2, lty = 1)
...
X.simu.bm.pero10[length(tset)] # black simulation
...
Y.simu.bm.pero10[length(tset)] # black simulation
